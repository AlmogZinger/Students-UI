...
class Mutation : public qtgql::bases::ObjectTypeABC {
  Q_OBJECT
public:
  std::map<std::tuple<QString, qtgql::customscalars::DateScalar>,
...
public:
  [[nodiscard]] const std::shared_ptr<Student> &get_addStudent(
      std::tuple<QString, qtgql::customscalars::DateScalar> args) const {
    return m_addStudent.at(args);
  }
  void
  set_addStudent(const std::shared_ptr<Student> &v,
                 std::tuple<QString, qtgql::customscalars::DateScalar> args) {
    m_addStudent[args] = v;
    emit addStudentChanged();
  };

  [[nodiscard]] const std::shared_ptr<Student> &
  get_submitTestResults(std::tuple<int, QString, int> args) const {
    return m_submitTestResults.at(args);
  }
  void set_submitTestResults(const std::shared_ptr<Student> &v,
                             std::tuple<int, QString, int> args) {
...
public:
  [[nodiscard]] const std::vector<std::shared_ptr<Student>> &
  get_students() const {
    return m_students;
  }
...
public:
  ...
  [[nodiscard]] const QString &get_name() const { return m_name; }
  void set_name(const QString &v) {
    m_name = v;
    emit nameChanged();
  };

  [[nodiscard]] const QString &get_birthDate() { return m_birthDate.to_qt(); }
...
class Test : public qtgql::bases::ObjectTypeABC {
  Q_OBJECT
public:
  QString m_subject = qtgql::bases::DEFAULTS::STRING;
  int m_grade = qtgql::bases::DEFAULTS::INT;
...
public:
  [[nodiscard]] const QString &get_subject() const { return m_subject; }
  void set_subject(const QString &v) {
    m_subject = v;
    emit subjectChanged();
  };

  [[nodiscard]] const int &get_grade() const { return m_grade; }
